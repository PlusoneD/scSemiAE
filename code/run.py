...
# Training settings:
parser.add_argument("-dpath", "--data-path", default="./dataset/", help="path to the dataset folder")
...
parser.add_argument("-lratio", "--lab-ratio", type=float, default=0.1, help="labeled set ratio for each cell type (default: -1)")

parser.add_argument("-s", "--seed", type=int, default=0, help="random seed for loading dataset (default: 0)")
parser.add_argument('--cuda', action='store_true', help='enables cuda')
parser.add_argument('-pretrain_batch', '--pretrain-batch', type=int, help="Batch size for pretraining.Default:100", default=100)
